...
Aby postawić cały system na swoim komputerze, zalecam wykorzystanie środowiska Podman. Użycie polecenia Podman Compose automatycznie podniesie lokalny węzeł IPFS, bramę w języku Rust oraz wszystkie kontenery z symulatorami maszyn przemysłowych. System jest również w pełni kompatybilny ze standardowym narzędziem Docker Compose. Panel sterowania będzie od razu gotowy do podglądu pod adresem localhost na porcie 8090.
